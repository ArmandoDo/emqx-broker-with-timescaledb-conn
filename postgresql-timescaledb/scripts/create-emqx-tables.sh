...
-- Create INDEX
CREATE INDEX idx_time ON dispensers_log(time);
...
SELECT create_hypertable('dispensers_log', 'time');
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE dispensers_log TO $POSTGRES_ADMIN_USER;
